...
const AddProducts = () => {
    const handleAddProduct = event => {
        ...
        fetch('https://brand-shop-server-sable-gamma.vercel.app/product/product', {
            method: 'POST',
            headers: {
    ...
    return (
        ...
        <div className='lg:px-[160px] lg:py-[100px] md:px-[30px] md:[30px] '>
            <h2 className='text-[60px] text-[#1B3C35] font-medium mb-[10px] md:text-center'>Add products</h2>
            <p className='md:text-center text-[#AEC3BE] text-[18px] font-normal mb-[38px]'>Dolor consectetuer posuere maecenas tempor pede tellus. <br /> Nec eros curae luctus hac elementum penatibus pulvinar <br /> faucibus potenti vestibulum blandit.</p>
            <div className='bg-[#ECEDE8] rounded-[10px] py-[60px] px-[100px] '>
                <form onSubmit={handleAddProduct}>
                    <div className=' lg:flex md:text-center gap-[50px] mb-8'>
